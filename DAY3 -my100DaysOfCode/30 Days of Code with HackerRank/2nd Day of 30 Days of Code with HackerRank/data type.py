#Task 
#Complete the code in the editor below. The variables i, d, s
...
#Explanation
#When we sum the integers 4 and 12, we get the integer 
#16
#When we sum the floating-point numbers 4.0 and 4.0 , we get 
#8.0
